...
impl BlinkCursor {
    ...
    /// Start the blinking
    pub fn start(&mut self, cx: &mut Entity<Self>) {
        self.blink(self.epoch, cx);
    }

    pub fn stop(&mut self, cx: &mut Entity<Self>) {
        self.epoch = 0;
        cx.notify();
    }
    ...
    fn blink(&mut self, epoch: usize, cx: &mut Entity<Self>) {
    ...
    pub fn pause(&mut self, cx: &mut Entity<Self>) {
        self.paused = true;
        cx.notify();
